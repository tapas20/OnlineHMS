...
import { FaFacebookF, FaTwitter, FaInstagram, FaHeartbeat, FaUserAlt, FaBell, FaHistory, FaTint } from "react-icons/fa";
      ...
      <header className="bg-red-50 sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <NavLink to="/forecastdashboard" className="text-gray-700 hover:text-red-600 font-medium transition-colors">
              AI Predictions
            </NavLink>
            <NavLink to="/blockchain" className="text-gray-700 hover:text-red-600 font-medium transition-colors">
              Blockchain Records
            </NavLink>
            <a href="#" className="text-gray-700 hover:text-red-600 font-medium transition-colors">
              Contact
            ...
            <div className="relative">
              ...
              {showDetails && (
                <div className="absolute right-0 mt-2 bg-white p-6 rounded-xl shadow-xl w-80 border border-red-100">
                  <h2 className="text-2xl font-bold mb-4 text-red-700">Donor Profile</h2>
                  <div className="space-y-3">
                    <p><strong className="text-gray-700">Name:</strong> John Doe</p>
                    <p><strong className="text-gray-700">Blood Type:</strong> <span className="text-red-600 font-semibold">A+</span></p>
                    <p><strong className="text-gray-700">Location:</strong> New York, USA</p>
                    <p><strong className="text-gray-700">Last Donation:</strong> March 15, 2025</p>
                    <p><strong className="text-gray-700">Points Earned:</strong> 1,250</p>
                    <p><strong className="text-gray-700">Status:</strong> <span className="text-green-600 font-semibold">Eligible to donate</span></p>
                  </div>
        ...
        <div className="container mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-12 md:mb-0">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Give <span className="text-red-600">Blood</span>,<br />Save <span className="text-red-600">Lives</span>
            </h1>
            <p className="text-lg text-gray-600 mb-8 max-w-lg">
              Join our community of heroes who make a difference every day. Your single donation can save up to 3 lives.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="flex justify-center space-x-4">
            <button 
              ...
              className={`flex flex-col items-center p-4 rounded-xl w-24 transition-all ${activeTab === 'donate' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
            >
            ...
            <button 
              ...
              className={`flex flex-col items-center p-4 rounded-xl w-24 transition-all ${activeTab === 'request' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
            >
            ...
            <button 
              ...
              className={`flex flex-col items-center p-4 rounded-xl w-24 transition-all ${activeTab === 'history' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
            >
            ...
            <button 
              ...
              className={`flex flex-col items-center p-4 rounded-xl w-24 transition-all ${activeTab === 'notifications' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
            >
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Every donation creates a ripple effect of hope and healing in your community.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900">Immediate Impact</h3>
              <p className="text-gray-600">
                Your blood donation can be used within 24 hours to save lives in emergency situations.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Join a network of donors who are committed to making their communities healthier and safer.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Regular donors enjoy health benefits including reduced risk of heart disease and free health screenings.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Schedule your donation appointment today and join our life-saving mission.
          </p>
